...
>>>>>>> 7f229bd528b1d500d71eb18a8a29049416d3e7e7
            ...
            <div className={styles.container}>
              <div>
                ...
                {(post.post.layout === "branch-head" && (
                  <h1 className={styles.branchhead}>{post.post.title}</h1>
                )) ||
                  (post.post.layout === "section-head" && (
                    <h1 className={styles.sectionhead}>{post.post.title}</h1>
                  )) ||
                ...
                {post.post.subtitle && (
                  <h3 className={styles.subtitle}>{post.post.subtitle}</h3>
                )}
                {post.post.layout === "branch-head" && (
