...
export async function PUT(req, { params }) {
	...
	// console.log(marg)
	// try {
	// Access the request body as a Buffer
	const body = await req.body?.read()
	console.log(body)
	// Parse the request body from Buffer to JSON
	const data = body ? JSON.parse(await body.toString()) : null

	// Access and use the data from the request body
	console.log(data)
