...
export async function getMarginalia(file_name) {
	try {
		...
		if (marginalia) {
			...
			if (
				JSON.stringify(marginalia) !== JSON.stringify(updatedMarginalia)
			) {
