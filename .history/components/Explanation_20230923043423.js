	...
	return (
		<>
			<div className='explanation'>
				...
				>
					<MagicCard className='flex w-4/12 xl:w-4/12 p-4 cursor-pointer gap-2 flex-col items-center justify-center overflow-hidden p-20 shadow-2xl'>
					...
					<MagicCard
						className='flex w-4/12 xl:w-4/12  p-4 cursor-pointer flex-col gap-2 items-center justify-center overflow-hidden p-20 shadow-2xl'
						spotlight
					>
						<p className='z-10 whitespace-nowrap text-3xl font-medium text-white-800 dark:text-white-200 txt'>
							Navigation
