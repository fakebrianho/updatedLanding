			...
			{child_xy.nodePositions &&
				...
				child_xy.nodePositions.map((pos, i) => {
					...
					const style = {
						...
						position: 'absolute',
						display: 'flex',
						justifyContent: child_xy.angles[i] === 0 || child_xy.angles[i] === Math.PI ? 'center' : (isRightSide ? 'flex-start' : 'flex-end'),
						alignItems: child_xy.angles[i] === Math.PI/2 ? 'flex-start' : (child_xy.angles[i] === -Math.PI/2 ? 'flex-end' : 'center'),
					};
					}
					return (
