		...
		<>
			...
			<div className='description tangible_abstract'>
				<p className='text'>
					...
					<span className='bold_text'>serious</span>, abstract and
					concrete. Its structure is fractal, but you can read it like
					a linear book, or freely skip around the knowledge graph.
				</p>
			...
			<MagicContainer
				borderWidth={3}
				className={
					'flex h-[300px] w-[500px] flex-col gap-4 lg:h-[125px] lg:flex-row'
				}
			>
