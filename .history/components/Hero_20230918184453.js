		...
		<>
			<section className='hero_section'>
				<div className='circle_container'>
					<div className='orange_gradient' id='circle_0'></div>
					<div className='circle_blue_halo' id='circle_1'>
						<div className='circle_small_blue'></div>
					</div>
					<div className='circle_blue_halo' id='circle_2'></div>
					<div className='circle_blue_halo' id='circle_3'></div>
					<div className='circle_small_blue' id='circle_4'></div>
				</div>
