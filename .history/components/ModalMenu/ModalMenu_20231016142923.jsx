...
export default function ModalMenu(props) {
	...
	return (
		...
		>
			<MagicCard
				className='flex flex-col items-center justify-center p-20 shadow-2xl  menu fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 modal pointer-events-auto'
				ref={modal}
			>
				{' '}
