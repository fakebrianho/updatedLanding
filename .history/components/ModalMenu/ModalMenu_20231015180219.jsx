...
export default function ModalMenu() {
	return (
		<MagicContainer
			borderWidth={3}
			className={
				'flex items-center justify-center min-h-screen min-w-screen' // Updated classes for centering and full screen
			}
		>
			<MagicCard className='flex flex-col items-center justify-center p-20 shadow-2xl card menu w-[80%] h-[80%] mx-auto my-auto relative'>
				{' '}
				// Updated classes for making card larger and centering
