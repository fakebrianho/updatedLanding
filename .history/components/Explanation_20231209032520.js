	...
	return (
		<>
			<div className='explanation'>
				...
				>
					<MagicCard className='flex w-4/12 xl:w-4/12 p-4 cursor-pointer gap-2 flex-col items-center justify-center overflow-hidden p-20 shadow-2xl card relative'>
						<div className='z-2001 absolute p-12'>
							<p className='z-10 text-xl font-medium text-white-800 dark:text-white-200 txt'>
								Start reading: The easiest way to start is the
