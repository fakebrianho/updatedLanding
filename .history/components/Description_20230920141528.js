	...
	return (
		<>
			...
			<div className='description tangible_abstract'>
				<p className='text'>
					It is both <i>playful</i> and <strong>serious</strong>,
					abstract and concrete. Its structure is fractal, but you can
					read it like a linear book, or freely skip around the
					knowledge graph.
				</p>
