	...
	return (
		<>
			...
			<MagicContainer
				borderWidth={3}
				className={
					'flex mx-auto w-[30px] flex-col gap-4 lg:h-[250px] lg:w-max lg:flex-row lg:mx-auto lg:flex-wrap'
				}
			>
				<MagicCard className='flex max-w-1/3 full cursor-pointer flex-col items-center justify-center overflow-hidden p-20 shadow-2xl'>
